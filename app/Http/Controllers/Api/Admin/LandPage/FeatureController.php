...
class FeatureController extends Controller
{
    public function store(StoreFeatureRequest $request)
    {
        try {
            ...
            return mainResponse(true, 'Feature section created successfully.', compact('featureSection'), [], 201);
        } catch (\Exception $e) {
            return mainResponse(false, 'Failed to store feature section.', [], ['server' => [$e->getMessage()]], 500);
        }
    }
